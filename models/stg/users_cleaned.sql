...
SELECT 
    ...
    ,COALESCE(l.first_transaction_date, Extract(DATE FROM u.created_date)) AS first_transaction_date
    ,COALESCE(l.last_transaction_date, Extract(DATE FROM u.created_date)) AS last_transaction_date
    --
